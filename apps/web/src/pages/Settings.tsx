...
export default function Settings() {
  ...
  const [vals, setVals] = useState<Record<string, SettingValue>>(() =>
    SERVER_SETTING_GROUPS.flatMap((g) => g.settings).reduce(
      (a, s) => ({ ...a, [s.key]: s.value }),
      {}
    )
  )
  ...
  return (
    <div className="main fadein">
      <PageHeader
        ...
        actions={
          <>
            <button className="btn btn-ghost btn-sm" onClick={reloadFromFile}>
              Reload from File
            </button>
        ...
        <div className="card" style={{ position: 'sticky', top: '16px' }}>
          ...
          <div className="card-body-0">
            <div className="json-pane">
              ...
              <br />
              {SERVER_SETTING_GROUPS.flatMap((g) => g.settings).map((s) => (
